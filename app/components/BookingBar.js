...
export default function BookingBar() {
  return (
    <div className="w-[1152px] h-28 bg-white rounded-md shadow-[0_4px_15px_rgba(0,0,0,0.05)] flex items-center justify-center">
      <div className="flex items-center gap-24">
        ...
        {/* Button */}
        <button className="flex items-center gap-[10px] bg-[#0F6A64] text-white font-poppins text-[20px] leading-[20px] tracking-[-0.012em] rounded-md px-6 py-3">
          Check availability
        </button>
      </div>
    </div>
